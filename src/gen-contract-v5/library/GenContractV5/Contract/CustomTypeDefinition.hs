...
module GenContractV5.Contract.CustomTypeDefinition
...
import GenContractV4.Contract (EnumVariant)
import GenContractV4.Contract qualified as V4
import GenContractV5.Contract.Member (Member, toV4Member)
import GenContractV5.Contract.Value (Value, toV4Value)
