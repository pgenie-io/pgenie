module Analysis.Procedures.ResolveParamNullabilities.DefaultEncoder
  ( fromType,
  )
where

import Analysis.Domain
import Analysis.Procedures.ResolveParamNullabilities.DefaultEncoder.DefaultValues qualified as DefaultValues
