...
module GenContractV5.Contract.Project
  ( Project (..),
    toV4Project,
  )
where
...
import GenContractV4.Contract (Migration, Name, Version)
import GenContractV4.Contract qualified as V4
import GenContractV5.Contract.CustomType (CustomType, toV4CustomType)
import GenContractV5.Contract.Query (Query, toV4Query)
