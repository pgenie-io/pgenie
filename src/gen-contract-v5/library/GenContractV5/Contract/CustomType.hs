...
module GenContractV5.Contract.CustomType
  ( CustomType (..),
    toV4CustomType,
  )
where
...
import GenContractV4.Contract (Name)
import GenContractV4.Contract qualified as V4
import GenContractV5.Contract.CustomTypeDefinition (CustomTypeDefinition, toV4CustomTypeDefinition)
